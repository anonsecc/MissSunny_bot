...
```
from IHbot.sample_config import Config


class Development(Config):
    OWNER_ID = 482352271  # my telegram ID
    OWNER_USERNAME = "Indominus Rexx"  # my telegram username
...
The following env variables are supported:
 ...
 - `STRICT_GMUTE`: Enforce gmutes across new groups as well as old groups. The user won't be able to type anything.
